...
Error: File to import not found or unreadable: ...
       Load path: C:/wamp64/www/portfolio_website/node_modules/sass-ems/example
        on line 1 of C:\wamp64\www\portfolio_website\node_modules\sass-ems\example\example.scss

1: @import "..";
2: 
3: $base-font-size: 16px; //defaults to 16px if not set
4: 
5: h1 {
6:   padding: em(15px);

Backtrace:
C:\wamp64\www\portfolio_website\node_modules\sass-ems\example\example.scss:1
...
body:before {
  ...
  content: "Error: File to import not found or unreadable: ...\A        Load path: C:/wamp64/www/portfolio_website/node_modules/sass-ems/example\A         on line 1 of C:\wamp64\www\portfolio_website\node_modules\sass-ems\example\example.scss\A \A 1: @import \"..\";\A 2: \A 3: $base-font-size: 16px; //defaults to 16px if not set\A 4: \A 5: h1 {\A 6:   padding: em(15px);"; }
