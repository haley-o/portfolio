...
?> 
	...
	<div class="work-wrapper">
		...
		<div id="content-con">
			...
			<img class="mockup-image" src="images/lotr_home.png" alt="lord of the rings mockup">

			<h1 class="title">The Process</h1>
			<p class="desc">
				<?php
					$bio = "SELECT works_page_first_paragraph FROM `tbl_works_page` WHERE works_page_id = '2'";
			...
			<img class="mockup-image" src="images/lotr_timeline.png" alt="lord of the rings mockup">

			<h1 class="title"> The Result</h1>
			<p class="desc">
				<?php
					$bio = "SELECT works_page_second_paragraph FROM `tbl_works_page` WHERE works_page_id = '2'";
			...
			<img class="mockup-image" src="images/lotr_gallery.png" alt="lord of the rings mockup">
